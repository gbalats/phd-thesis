...
various extensions such as a more economic heap abstraction
\cite{sas/ManevichSRF04}, or the incorporation of a value analysis
into the shape analysis algorithm~\cite{sefm/FerraraFJ12}.
