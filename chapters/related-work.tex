...
the degree of context sensitivity \cite{oopsla/OhYY15}. Other
approaches use counter-example-guided abstraction refinements, using
the feedback from failed analysis runs to pick a new abstraction which
is less likely to fail \cite{pldi/ZhangMGNY14,tacas/GulavaniR06}.
