...
%-------------------------------------------------------------------------------
% Summary (former Conclusions)
%-------------------------------------------------------------------------------

\section{Summary}

In this chapter, we introduced the class hierarchy complementation
...
hierarchy complementation in Section~\ref{hiercomp/intro}, and show how
the problem arises in practice in Section~\ref{hiercomp/motivation}.
%
...
\ref{hiercomp/multiple} and \ref{hiercomp/single}, respectively).
%
In Section~\ref{hiercomp/java}, we showed how to decompose the problem
...
(instead of bytecode), in Section~\ref{hiercomp/discussion}.

% TODO put in conclusions
% We believe that the hierarchy complementation
% problem is fundamental and is likely to arise in different settings in
% the future, hopefully aided by our modeling of the problem and some of
% its solution avenues.
