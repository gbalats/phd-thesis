...
\begin{figure}[htp]
  ...
  \caption{In any solution of these constraints, either $B$ or $C$ or
    $D$ have to be ordered below $E$, since no new outgoing edges can
    be added to $A$ and the path constraint to $E$ needs to be
    satisfied.}
\label{fig:choice}
\end{figure}
...
\begin{figure*}[t]
  ...
  \end{minipage}
  \caption{An example of the stratification produced by the
    multiple-inheritance solver for Example~\ref{fig:multipleHard}.}
