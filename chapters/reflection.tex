...
\(o_{i,\tp{*}}\,\), then retrieve the object's \code{forName} invocation
site, \var{i}, and infer that this invocation site returns a class
object of type \tp{T'}, where \tp{T'} is a subtype of \var{T}.
