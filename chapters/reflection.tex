...
especially in determining the types of the abstract objects
constructed by the analysis, lies in the usage of Java's reflection
mechanism: the ability to inspect and dynamically call classes,
